...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        print(concepts_list)
        self.instance_images_path = sorted(glob(concepts_list+'*.png'))
        img_txt_path = sorted(glob(concepts_list+'*.txt'))
        ...
        self.class_images_path = sorted(glob('/data/ephemeral/home/dreambooth/logo/*.png'))
...
def main(args):
    ...
    #         args.concepts_list = json.load(f)
        args.concepts_list = args.concepts_list

    if args.with_prior_preservation:
        pipeline = None
        
        class_images_dir = sorted(glob('/data/ephemeral/home/dreambooth/logo/*.png'))
        #class_images_dir.mkdir(parents=True, exist_ok=True)
        cur_class_images = len(class_images_dir)
        ...
        if cur_class_images < args.num_class_images:
            ...
            sample_dataset = PromptDataset('a logo', num_new_images)
